class MyPostPage{
    ...
    constructor(page){
        ...
        //Filter Hubs/Stores
        this.filterByAllHubs = page.locator('div:nth-child(2) > div:nth-child(2) > .css-1pcexqc-container > .css-bg1rzq-control');
        ...
        this.filterByAllPrefferedPartners = page.locator('div:nth-child(4) > div:nth-child(2) > .css-1pcexqc-container > .css-bg1rzq-control');
        let locationNumbersOfPrefferedPartners;
        this.filterByPartners = page.locator('#react-select-4-option-'+{locationNumbersOfPrefferedPartners}+'');
